...
print("Loading Data ...")
# air_reserve
df_ar = pd.read_csv('data-temp/air_reserve.csv')
# air_store_info
df_as = pd.read_csv('data-temp/air_store_info.csv')
# air_visit_data
df_av = pd.read_csv('data-temp/air_visit_data.csv')
# hpg_reserve
df_hr = pd.read_csv('data-temp/hpg_reserve.csv')
# hpg_store_info
df_hs = pd.read_csv('data-temp/hpg_store_info.csv')
# date_info
df_di = pd.read_csv('data-temp/date_info.csv')
# sample_submission
df_ss = pd.read_csv('data-temp/sample_submission.csv')
# store_id_relation
df_si = pd.read_csv('data-temp/store_id_relation.csv')

# df_test
df_test = pd.read_csv('data-temp/sample_submission.csv')
...
print(train.columns)
print(test.columns)
test.to_csv("data-temp/test-temp.csv", index=False)
quit()
#
# =============================================================================
# shuffle dataset
...
result.to_csv('data-temp/LGB_sub.csv', index=False)
